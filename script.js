document.addEventListener("DOMContentLoaded", () => {
  ...
  // Gallery Data - Updated with correct images from user
  const galleryItems = {
    funilaria: {
  ...
  // Update Active Section - Updated order: hero, servicos, galeria, diferenciais, contato, faq
  function updateActiveSection() {
    const sections = ["hero", "servicos", "galeria", "diferenciais", "contato", "faq"]
